...
function DropdownMenuLabel({
  ...
  return (
    <DropdownMenuPrimitive.Label
      ...
      data-inset={inset}
      className={cn(
        "relative px-2 py-1.5 text-xs font-semibold text-foreground data-inset:ps-7",
        className
      )}
      {...props}
    />
...
function DropdownMenuSeparator({
  ...
  return (
    <DropdownMenuPrimitive.Separator
      ...
      className={cn("relative -mx-1 my-1 h-px bg-border", className)}
      {...props}
    />
  )
}
