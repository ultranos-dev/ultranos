 ...
 * 4. ConsentExpiryBanner — when consent expiry date is provided
 * 5. BiometricStaleBanner — when biometric algorithm version mismatches expected
 */
export function PatientBannerStack({
  ...
  return (
    <div data-testid="patient-banner-stack">
      ...
      {/* 4. Consent expiry — only when expiry date provided */}
      {consentExpiryDate && (
        <ConsentExpiryBanner
          patientId={patientId}
      ...
      {/* 5. Biometric stale — only when version mismatches */}
