...
import type { DrugBrand, DrugBrandPresentation, PharmacyDirectoryEntry, LabDirectoryEntry } from '@ultranos/shared-types'
...
class OpdLiteDatabase extends Dexie {
  ...
  constructor() {
    ...
    // v27: Lab directory mirror (non-PHI reference data).
    // Synced from Hub; used offline for lab picker during service-request dispatch.
