...
const ps: Translations = {
  ...
  home: {
    ...
    dismissAlertTitle: 'خبرتیا پټه کړئ؟',
    dismissAlertMessage: 'دا د خوندیتوب خبرتیا به ستاسو له اصلي پاڼې پټه شي.',
    dismissAlertConfirm: 'پټول',
    dismissAlertA11y: 'خبرتیا پټول',
    recent: 'وروستي',
    clearRecent: 'وروستي لټونونه پاک کړئ',
    clearRecentTitle: 'وروستي لټونونه پاک شي؟',
    clearRecentMessage: 'دا به ستاسو د وروستي لټون تاریخچه له دې وسیلې پاکه کړي.',
    clearRecentConfirm: 'پاکول',
    saved: 'خوندي شوي',
    seeAll: 'ټول وګورئ',
  ...
  profile: {
    ...
    alertsSection: 'د خوندیتوب خبرتیاوې',
    alertReappearLabel: 'پټې شوې خبرتیاوې بیا ښکاره کړئ وروسته له',
    alertReappearDays: '{{count}} ورځې',
    alertReappearNever: 'هیڅکله',
  },
  login: {
    title: 'فارماپیدیا',
