...
const prs: Translations = {
  ...
  home: {
    ...
    dismissAlertTitle: 'پنهان کردن هشدار؟',
    dismissAlertMessage: 'این هشدار ایمنی از صفحه اصلی شما پنهان خواهد شد.',
    dismissAlertConfirm: 'پنهان کردن',
    dismissAlertA11y: 'پنهان کردن هشدار',
    recent: 'اخیر',
    clearRecent: 'پاک کردن جستجوهای اخیر',
    clearRecentTitle: 'جستجوهای اخیر پاک شود؟',
    clearRecentMessage: 'این کار تاریخچهٔ جستجوی اخیر شما را از این دستگاه حذف می‌کند.',
    clearRecentConfirm: 'پاک کردن',
    saved: 'ذخیره‌شده',
    seeAll: 'مشاهده همه',
  ...
  profile: {
    ...
    alertsSection: 'هشدارهای ایمنی',
    alertReappearLabel: 'نمایش دوبارهٔ هشدارهای پنهان‌شده پس از',
    alertReappearDays: '{{count}} روز',
    alertReappearNever: 'هرگز',
  },
  login: {
    title: 'فارماپدیا',
