...
const ar: Translations = {
  ...
  home: {
    ...
    dismissAlertTitle: 'إخفاء التنبيه؟',
    dismissAlertMessage: 'سيتم إخفاء تنبيه السلامة هذا من الشاشة الرئيسية.',
    dismissAlertConfirm: 'إخفاء',
    dismissAlertA11y: 'إخفاء التنبيه',
    recent: 'الأخيرة',
    clearRecent: 'مسح عمليات البحث الأخيرة',
    clearRecentTitle: 'مسح عمليات البحث الأخيرة؟',
    clearRecentMessage: 'سيؤدي هذا إلى إزالة سجل بحثك الأخير من هذا الجهاز.',
    clearRecentConfirm: 'مسح',
    saved: 'المحفوظة',
    seeAll: 'عرض الكل',
  ...
  profile: {
    ...
    alertsSection: 'تنبيهات السلامة',
    alertReappearLabel: 'إعادة إظهار التنبيهات المُخفاة بعد',
    alertReappearDays: '{{count}} يومًا',
    alertReappearNever: 'أبدًا',
  },
  login: {
    title: 'فارموبيديا',
