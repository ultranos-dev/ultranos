  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <p className="text-sm font-medium text-text-primary">KYC SLA breach alerts</p>
          <p className="text-xs text-text-secondary">Get notified when KYC reviews exceed SLA deadlines.</p>
        </div>
      ...
      <div>
        <p className="text-sm font-medium text-text-primary">License expiry warnings</p>
        <p className="text-xs text-text-secondary mb-2">Choose when to receive license expiry reminders.</p>
      ...
      <div>
        <p className="text-sm font-medium text-text-primary">Prescribing anomaly alerts</p>
        <p className="text-xs text-text-secondary mb-2">Control the severity level of prescribing anomaly notifications.</p>
        <div className="flex flex-wrap gap-4">
      ...
      <div className="flex items-center justify-between">
        <div>
          <p className="text-sm font-medium text-text-primary">Audit chain integrity failure</p>
          <p className="text-xs text-text-secondary">Alert when audit log hash chain integrity checks fail.</p>
        </div>
      ...
      <div>
        <p className="text-sm font-medium text-text-primary">Trial expiry reminders</p>
        <p className="text-xs text-text-secondary mb-2">Choose when to receive trial expiry reminders.</p>
        <div className="flex flex-wrap gap-4">
