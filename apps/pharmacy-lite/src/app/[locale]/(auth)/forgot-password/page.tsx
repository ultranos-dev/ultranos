...
import { Pill, MailCheck } from '@ultranos/ui-kit/icons'
    ...
    <div className="grid min-h-svh lg:grid-cols-2">
      <div className="flex flex-col p-6 md:p-10">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2.5">
            ...
            <span className="font-heading text-sm font-semibold text-foreground">Pharmacy Lite</span>
          </div>
      ...
      <div className="relative hidden overflow-hidden bg-primary lg:flex lg:flex-col lg:items-center lg:justify-center">
        ...
        <div className="relative z-10 px-12 text-center text-primary-foreground">
          ...
          <p className="mt-3 text-base text-primary-foreground/75">Medication management and dispensing</p>
