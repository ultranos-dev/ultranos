  ...
  if (total === 0) {
    return (
      <div className="rounded-lg border border-success/20 bg-success/5 p-4" data-testid="inventory-alert-card">
        <p className="text-sm font-medium text-success">Inventory healthy — no alerts</p>
      </div>
    )
  }
