          ...
          <table className="w-full text-sm">
            <thead className="border-b border-border bg-muted">
              <tr>
                ...
                <th className="px-4 py-3 text-start font-medium text-muted-foreground">Contact</th>
                <th className="px-4 py-3 text-start font-medium text-muted-foreground">Phone</th>
