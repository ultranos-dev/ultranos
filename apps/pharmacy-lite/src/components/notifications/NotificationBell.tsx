...
/**
 * Pharmacy notification bell — unread badge + dropdown panel.
 * Uses useNotificationPoll for badge count (30s polling, <60s SLA).
 * The same hook instance in the panel handles full notification list.
 */
