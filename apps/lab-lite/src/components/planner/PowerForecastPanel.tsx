...
export function PowerForecastPanel({ forecast }: Props) {
  ...
  return (
    <div className="rounded-lg border border-neutral-200 bg-white p-4 space-y-4">
      ...
      {forecast.solarAvailabilityHours !== null && (
        <div>
          <p className="text-xs text-neutral-500 mb-1">Power coverage (solar vs generator)</p>
          <div className="relative h-4 rounded-full bg-neutral-200 overflow-hidden">
            <div
          ...
          <div className="flex justify-between text-xs text-neutral-500 mt-1">
            ...
            <span className="flex items-center gap-1"><span className="inline-block w-2 h-2 rounded-full bg-neutral-300" />Generator</span>
          </div>
        </div>
      )}
