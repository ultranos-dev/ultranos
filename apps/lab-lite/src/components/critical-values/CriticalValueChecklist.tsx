      ...
      <div className="relative w-full max-w-lg rounded-xl bg-card shadow-2xl mx-4">
        ...
        <div className="flex items-center justify-end gap-3 border-t border-border/50 px-4 py-3 rounded-b-xl">
          <button
            type="button"
            onClick={onCancel}
            className="rounded-lg border border-border px-4 py-2 text-sm font-medium text-foreground hover:bg-muted/30 transition-colors focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-ring"
