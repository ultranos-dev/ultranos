    ...
    <div className="flex flex-col gap-4">
      ...
      <div className="flex gap-2">
        <input
          ...
          className="flex-1 rounded-lg border border-neutral-300 px-4 py-2 text-sm focus:border-primary-500 focus:outline-none focus:ring-2 focus:ring-primary-500"
        ...
        <button
          ...
          disabled={searching}
          className="rounded-lg bg-neutral-100 px-4 py-2 text-sm text-neutral-700 hover:bg-neutral-200 disabled:opacity-50"
        >
      ...
      {view === 'create' && (
        <div className="rounded-lg border border-neutral-200 bg-white p-4">
          <h2 className="mb-4 text-lg font-semibold text-neutral-900">{t('createPost')}</h2>
          <CreatePostForm
      ...
      {view === 'search' && (
        <div className="flex flex-col gap-3">
          ...
          {searchResults.length === 0 ? (
            <p className="py-8 text-center text-sm text-neutral-500">{t('noSearchResults')}</p>
          ) : (
            searchResults.map(({ post, hasVerifiedAnswer }) => (
              <button
                ...
                className="w-full rounded-lg border border-neutral-200 p-3 text-start hover:border-primary-300 hover:bg-neutral-50"
              >
                ...
                <p className="mt-1 truncate text-xs text-neutral-600">{post.body}</p>
